...
namespace Leap.Unity
{
    ...
    public class CapsuleHand : HandModelBase
    {
        ...
        public Vector handtake;
        public Quaternion handPalmRot;
        ...
        private void Update()
        {
            if (_hand != null)
            {
                handtake = _hand.PalmPosition;
                handRotation = _hand.Arm.Rotation.ToQuaternion();
                handPalmRot = _hand.Rotation.ToQuaternion();
            }
        }
