...
namespace Leap.Unity
{
    ...
    public class RiggedHand : HandModel
    {
        ...
        [Tooltip("When True, hands will be put into a Leap editor pose near the LeapServiceProvider's transform.  " 
                 + "When False, the hands will be returned to their Start Pose if it has been saved.")]
        [SerializeField]
        [HideInInspector]
        ...
        private void Update()
        {
            Debug.Log(jointList[1].position.x);
